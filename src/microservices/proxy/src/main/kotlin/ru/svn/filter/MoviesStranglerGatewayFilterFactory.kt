    ...
    override fun apply(config: Config): GatewayFilter {
        return GatewayFilter { exchange, chain ->
            ...
            val newUrl = UriComponentsBuilder.fromUri(targetBase)
                .path(incoming.rawPath)          // сохраняем /api/movies/...
                .query(incoming.rawQuery)        // сохраняем query string
                .build(true)
                .toUri()
            ...
            log.info(
                "Movies route: path={}, gradual={}, percent={}, random={}, target={}",
                incoming.rawPath, props.gradualMigration, percent, String.format("%.2f", random), targetLabel
            )
